...
const Documenti = () => {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/get_documents`, {
          headers: {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/upload_document?filename=${filename}`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      ...
      const resDocs = await fetch(`${process.env.REACT_APP_API_BASE_URL}/get_documents`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
        },
      });
